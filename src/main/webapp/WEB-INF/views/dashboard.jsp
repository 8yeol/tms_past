                            ...
                            <div class="d-flex justify-content-center mt-3" style="font-size: 13px">
                                <div class="fw-bold">
                                    <p class="m-0 text-center text-primary">
                                        <fmt:formatNumber value="${present.totalEmissions}"
                                                          pattern=",000"/></p>${present.year}년 현재 배출량
                                </div>
                                <p class="fs-3" style="margin: 0 0.5rem 0;">/</p>
                                <div class="fw-bold">
                                    <p class="m-0 text-center">
                                        <fmt:formatNumber value="${past.totalEmissions}"
                                                          pattern=",000"/></p>${past.year}년 총 배출량
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center" style="padding: 1rem 1rem 0;">
                                ...
                                <p class="fw-bold fs-3">
                                    <fmt:formatNumber value="${present.totalEmissions - past.totalEmissions}"
                                                      pattern=",000"/></p>
                            </div>
                            <hr class="text-primary m-0">
                            <div class="d-flex justify-content-center mt-3" style="font-size: 13px">
                                <div class="fw-bold">
                                    <p class="m-0 text-center text-primary">
                                        <fmt:formatNumber value="${presentQuater}"
                                                          pattern=",000"/></p>${present.year}년 ${quarter}분기
                                </div>
                                <p class="fs-3 mx-2">/</p>
                                <div class="fw-bold">
                                    <p class="m-0 text-center">
                                        <fmt:formatNumber value="${pastQuater}"
                                                          pattern=",000"/></p>${past.year}년 ${quarter}분기
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-2 border-primary" style="height: 95%;">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center" style="padding: 1rem 1rem 0;">
                                <p class="fw-bold me-3" style="margin-top: 0.8rem;">전년대비</p>
                                <p class="fw-bold fs-3">
                                    <fmt:formatNumber value="${(presentQuater - pastQuater) / pastQuater * 100}"
                                                      pattern=".0"/>%</p>
                            </div>
                            <hr class="text-primary m-0">
                            <div class="d-flex justify-content-center mt-3" style="font-size: 13px">
                                ...
                                <c:forEach items="${standard}" var="standard">
                                    <c:if test="${emissions.sensor eq standard.tableName}">
                                        <c:if test="${standard.emissionsStandard ne '0'}"> <!--sensor = standard -->
                                            ...
                                            <c:set var="percent"
                                                   value="${(emissions.yearlyValue*100)/(emissionsStandard)}"/>
                                            ...
                                            <div class="col">
                                                <div class="progress h-100">
                                                    ...
                                                    <div class="progress-bar progress-red" role="progressbar"
                                                         ...
                                                         aria-valuemax="100"><fmt:formatNumber
                                            ...
                                            ${percent}%
                                            <div class="standard">
                                                <fmt:formatNumber value="${standard.emissionsStandard}"
                                                                  groupingUsed="true"/>
                                            </div>
                                        </c:if>
