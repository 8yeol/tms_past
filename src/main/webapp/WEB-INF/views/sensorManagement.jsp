            ...
            success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    if (status1 == 0 || status2 == 0) {
                        status = '<i class="fas fa-circle" color="#50e400" onmouseover="statusMouseOn(\''+status1+'\', \''+status2+'\')" onmouseout="statusMouseOut();"></i>'
                    }
                    if ( status1 == 1 ) {
                        status = '<i class="fas fa-circle" color="#fcd521" onmouseover="statusMouseOn(\''+status1+'\', \''+status2+'\')" onmouseout="statusMouseOut();"></i>'
                    }
                    if ( status1 == 2 || status2 == 1) {
                        status = '<i class="fas fa-circle" color="#8600e4" onmouseover="statusMouseOn(\''+status1+'\', \''+status2+'\')" onmouseout="statusMouseOut();"></i>'
                    }
                    if ( status1 == 4 || status2 == 4) {
                        status = '<i class="fas fa-circle" color="#ff1c1c" onmouseover="statusMouseOn(\''+status1+'\', \''+status2+'\')" onmouseout="statusMouseOut();"></i>'
                    }
                    if ( status1 == 8 ) {
                        status = '<i class="fas fa-circle" color="#f49206" onmouseover="statusMouseOn(\''+status1+'\', \''+status2+'\')" onmouseout="statusMouseOut();"></i>'
                    }
