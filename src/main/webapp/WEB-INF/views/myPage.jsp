        ...
        <div class="container bg-light rounded p-5 text-center mt-5">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="">
                    ...
                    <input type="email" class="form-control text-center mt-1" value="${member.email}" id="email" onkeyup="autoEmail('email',this.value)">
                    <input type="tel" class="form-control text-center mt-1" value="${member.tel}" id="tel" onkeyup="inputPhoneNumber(this)">
